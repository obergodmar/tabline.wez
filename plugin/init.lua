...
local function get_require_path()
  -- HTTPS version
  local https_path = 'httpssCssZssZsgithubsDscomsZsobergodmarsZstablinesDswez'
  local https_path_slash = 'httpssCssZssZsgithubsDscomsZsobergodmarsZstablinesDswezsZs'
  -- HTTP version (without the 's' in https)
  local http_path = 'httpCssZssZsgithubsDscomsZsobergodmarsZstablinesDswez'
  local http_path_slash = 'httpCssZssZsgithubsDscomsZsobergodmarsZstablinesDswezsZs'
